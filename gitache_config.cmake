...
function(gitache_config)
  ...
  set(multiple GIT_SUBMODULES GIT_CONFIG CMAKE_ARGS)

  cmake_parse_arguments(PARSE_ARGV 0 ${gitache_package} "" "${one}" "${multiple}")

  set(external_project_arguments)
  foreach (_arg ${one})
    ...
    if (external_project_arguments)
      string(APPEND external_project_arguments " ")
    endif ()
    string(APPEND external_project_arguments ${_arg} " " "\"${${_variable_name}}\"")
  endforeach ()
  set(cmake_arguments)
  foreach (_arg ${multiple})
    ...
    if (_arg STREQUAL CMAKE_ARGS)
      set(cmake_arguments "${_sorted_arguments}")
    else ()
      if (external_project_arguments)
        string(APPEND external_project_arguments " ")
      endif ()
      string(APPEND external_project_arguments ${_arg} " " "${_sorted_arguments}")
    endif ()
  endforeach ()
  set(external_project_arguments "${external_project_arguments}" PARENT_SCOPE)
